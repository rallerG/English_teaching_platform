...
public class MyStudentMatchesRecyclerViewAdapter extends RecyclerView.Adapter<MyStudentMatchesRecyclerViewAdapter.ViewHolder> {

    private List<TeacherProfile> mProfiles;
    private  OnItemClickListener mListener;


    public MyStudentMatchesRecyclerViewAdapter(ArrayList<TeacherProfile> teacherDummies) {
        mProfiles = teacherDummies;
    }

    @Override
    public MyStudentMatchesRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recycler_view_card_item_student_matches, parent, false);
